...
update tb_pessoa set nome = 'Ludmyla' where id = 1;
update tb_pessoa set nome = 'Ludmyla', idade = 38 where id = 1;
...
select * from tb_pessoa where nome like('Ludmyla');
select * from tb_pessoa where nome like('L%');
select * from tb_pessoa where nome like('%a');
select * from tb_pessoa where nome like('%dmy%');
select * from tb_pessoa where nome like('_u___dmy%');
select * from tb_pessoa where nome not like('L%');
select nome from tb_pessoa;
select upper(nome) from tb_pessoa;
select * from tb_pessoa where idade >= 10 and idade < 39;
select * from tb_pessoa where idade >= 10 or nome like('Ludmyla');
...
select * from tb_pessoa where nome in ('Ludmyla', 'Luana');
